...
public class LastBossWeapon : MonoBehaviour {
    ...
    public int damageAmount = 350;
    HitAudioSource has;

    void Start()
    {
        has = enemy.GetComponent<HitAudioSource>();
        ea = enemy.GetComponent<LastBossPower>();
        infCtrl = enemy.GetComponent<LastBossCtrl>();
    }
