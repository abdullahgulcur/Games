...
public class SpearBossCtrl : MonoBehaviour {
    ...
    void Start()
    {
        ...
        lbp = GetComponent<SpearBossPower>();
    ...
    void FixedUpdate()
    {
        ...
        if (!died)
        {
            ...
            {
                rb.velocity = new Vector2(-Utility.EnemyDirection(player.transform, this.transform) * 8f, rb.velocity.y);
