...
namespace Invector.CharacterController
{
    public class vThirdPersonInput : MonoBehaviour
    {
        ...
        {
            cc.input.x = Input.GetAxis(horizontalInput); // A and D
            cc.input.y = Input.GetAxis(verticallInput); // W and S
        ...
        {
            if (Input.GetKeyDown(jumpInput) && !cc.isAttacking)
                cc.Jump();
        }
        ...
        protected virtual void AttackInput()
        {
            ...
            {
                if (!cc.isJumping && cc.isGrounded & !cc.isAttacking && !cc.isBlocking)
                    cc.Attack();
            }
        ...
        protected virtual void BlockInput()
        {
            ...
            {
                if (!cc.isJumping && cc.isGrounded & !cc.isAttacking)
                {
                    cc.Block();
                    cc.animator.SetBool("IsBlocking", true);
                }
            }
        }
        ...
        protected virtual void UnBlockInput()
        {
            ...
            {
                cc.isBlocking = false;
                cc.animator.SetBool("IsBlocking", false);
            }
